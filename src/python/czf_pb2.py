...
MCTSRoot = _reflection.GeneratedProtocolMessageType('MCTSRoot', (_message.Message,), dict(
...
GameOrigin = _reflection.GeneratedProtocolMessageType('GameOrigin', (_message.Message,), dict(
...
PreprocessRequest = _reflection.GeneratedProtocolMessageType('PreprocessRequest', (_message.Message,), dict(
