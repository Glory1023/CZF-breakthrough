...
namespace czf::actor::muzero_worker_gumbel {
namespace {

namespace py = ::pybind11;
using py::literals::operator""_a;

PYBIND11_MODULE(muzero_worker_gumbel, m) {  // NOLINT
  using czf::actor::muzero_worker_gumbel::GameInfo;
  ...
  using czf::actor::muzero_worker_gumbel::WorkerOption;
  ...
  using czf::actor::muzero_worker_gumbel::TreeOption;
  ...
  using czf::actor::muzero_worker_gumbel::worker::WorkerManager;
